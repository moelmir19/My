...
function subscriptionDemo($slug) {
    $services = [
        'netflix' => [
            ...
            'description' => 'اشتراك رقمي لمشاهدة الأفلام والمسلسلات عبر Netflix طوال مدة الباقة التي تختارها.',
            'details' => [
                'intro' => 'استمتع بمحتوى Netflix من أفلام ومسلسلات وبرامج عبر الأجهزة المدعومة. اختر الباقة المناسبة لك من الخيارات الموجودة في صفحة المنتج.',
                'features' => [
                    'الوصول إلى مكتبة Netflix طوال مدة الاشتراك المختارة.',
                    'المشاهدة عبر تطبيق Netflix على الأجهزة المدعومة.',
                    'اختيار مدة الاشتراك من الباقات المتاحة في المتجر.',
                    'منتج رقمي بدون شحن أو انتظار توصيل مادي.',
                ],
                'notes' => [
                    'نوع الحساب وطريقة الاستخدام تكون حسب تفاصيل الباقة المعروضة وقت الشراء.',
                    'توفر بعض العناوين والمحتوى قد يختلف حسب المنطقة وسياسات Netflix.',
                ],
                'activation' => [
                    'اختر مدة الاشتراك المناسبة وأكمل الطلب.',
                    'بعد إتمام الطلب اتبع بيانات أو تعليمات التفعيل التي يوفرها المتجر.',
                ],
            ],
            'plans' => [
        ...
        'youtube' => [
            ...
            'description' => 'اشتراك YouTube Premium لتجربة مشاهدة أكثر راحة مع مزايا Premium طوال مدة الباقة المختارة.',
            'details' => [
                'intro' => 'يوفر YouTube Premium مزايا إضافية للمشاهدة والاستماع، مع اختيار المدة المناسبة لك مباشرة من صفحة المنتج.',
                'features' => [
                    'مشاهدة فيديوهات YouTube بدون الإعلانات التي يعرضها YouTube داخل المحتوى.',
                    'تشغيل الفيديو والصوت في الخلفية على الأجهزة المدعومة.',
                    'إمكانية تنزيل المحتوى للمشاهدة بدون اتصال عند دعم الميزة.',
                    'الوصول إلى مزايا YouTube Music Premium ضمن الاشتراك.',
                ],
                'notes' => [
                    'توفر بعض المزايا قد يختلف حسب الجهاز أو المنطقة أو سياسات YouTube.',
                    'طريقة التفعيل ونوع الاشتراك تكون حسب تفاصيل الباقة المعروضة وقت الشراء.',
                ],
                'activation' => [
                    'اختر الباقة والمدة المناسبة ثم أكمل الطلب.',
                    'اتبع تعليمات التفعيل التي يوفرها المتجر بعد إتمام الطلب.',
                ],
            ],
            'plans' => [
        ...
        'osn' => [
            ...
            'description' => 'اشتراك رقمي للوصول إلى محتوى OSN طوال مدة الباقة المختارة من الخيارات المتاحة.',
            'details' => [
                'intro' => 'استمتع بمشاهدة محتوى OSN من خلال التطبيق على الأجهزة المدعومة، واختر المدة المناسبة لك من الباقات المتوفرة في المتجر.',
                'features' => [
                    'الوصول إلى محتوى الأفلام والمسلسلات المتاح ضمن الخدمة.',
                    'المشاهدة عبر تطبيق OSN على الأجهزة المدعومة.',
                    'اختيار اشتراك شهري أو سنوي حسب الباقات المتاحة.',
                    'تسليم رقمي بدون شحن مادي.',
                ],
                'notes' => [
                    'المحتوى المتاح قد يتغير حسب المنطقة وتحديثات مكتبة OSN.',
                    'نوع الحساب وطريقة التفعيل تكون حسب تفاصيل الباقة المعروضة وقت الشراء.',
                ],
                'activation' => [
                    'حدد مدة الاشتراك المطلوبة وأكمل الطلب.',
                    'استخدم بيانات أو تعليمات التفعيل التي يوفرها المتجر بعد إتمام الطلب.',
                ],
            ],
            'plans' => [
